// To flash using arduino-cli, verify --port and run from the same directory:
//
//   arduino-cli compile --fqbn=esp32:esp32:esp32 --log-level=debug --verbose \
//     --port=/dev/ttyUSB0 --upload --warnings=all arduino.ino
//
// The following Arduino core and libraries were used to verify this example:
//
